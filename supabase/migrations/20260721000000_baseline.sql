-- QR Meetup schema — baseline migration.
-- Captures the schema as it existed in supabase/schema.sql before this
-- project moved to Supabase CLI-managed migrations (2026-07-21). Tables
-- created ad hoc after this point (events, event_checkins, service_requests,
-- announcements) are NOT yet reflected here — see the follow-up migration
-- generated by `supabase db pull` once linked to the live project.
